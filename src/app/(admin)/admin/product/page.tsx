...
export default function User() {
  ...
  return (
    <main>
                  ...
                  <TableBody>
                    {paginatedProducts.map((product) => (
                      ...
                      >
                        ...
                        <TableCell align="left">{(product.categoryId as ICategory)?.name}</TableCell>
      ...
      <ProductDialog open={open} reload={reload} setOpen={setOpen} setReload={setReload} type={type} product={selectedProduct} />
    </main>
  );
}

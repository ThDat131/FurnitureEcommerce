    ...
    <ThemeProvider theme={theme}>
      ...
      >
        <Grid
          ...
          xs={12}
          sx={{
            backgroundImage: `url(${policyImg.src})`,
        ...
        <Grid xs={10} item>
          <Typography
            ...
            sx={{ paddingBottom: 4 }}
          >
            Công ty Epioneer là một công ty thương mại và dịch vụ với tiêu chí
            đem lại sự cải tiến, hiện đại trong các sản phẩm về điện cho người
            tiêu dùng. Chúng tôi luôn cố gắng hết sức để đi đầu trong lĩnh vực
            này với các sản phẩm tiên tiến, tiện dụng. Để mở rộng thị trường và
            nhằm đảm bảo chất lượng sản phẩm, công ty Epioneer đang tìm kiếm các
            đối tác, đại lý với các chính sách, ưu đãi.
          </Typography>
        </Grid>
          ...
          >
            ...
            >
              <Grid
                ...
                sx={{ mb: 2 }}
              >
                <Image src={expressImg} alt="icon" width={130} />
              </Grid>
          ...
          >
            ...
            >
              <Grid
                ...
                sx={{ mb: 2 }}
              >
                <Image src={paymentImg} alt="icon" width={120} />
              </Grid>
              <Grid xs={12} item justifyContent={"center"} container>
                <Typography
                  variant="h5"
        ...
        <Grid xs={10} item>
          ...
          <Typography
            ...
            sx={{ paddingBottom: 2 }}
          >
            Quý đại lý sẽ được hỗ trợ kỹ thuật qua điện thoại, qua email, hoặc
            hỗ trợ kỹ thuật trực tiếp tại chỗ khi có yêu cầu.Quý đại lý sẽ được
            chúng tôi tư vấn và hỗ trợ về giải pháp và kỹ thuật khi có yêu cầu.
          </Typography>
            ...
            >
              ...
              <Grid xs={12} item justifyContent={"center"} container>
                <Typography
                  ...
                  textAlign={"center"}
                >
                  Trong vòng 07 ngày kể từ giao hàng. Quý đại lý sẽ được đổi
                  hàng mới nếu sản phẩm được xác định lỗi từ nhà sản xuất.
                </Typography>
              </Grid>
            </Grid>
            <Grid md={4} xs={12} item container>
        ...
        <Grid xs={8} item>
          ...
          >
            ĐẠI LÝ KINH DOANH PHÁT TRIỂN LÀ NIỀM HẠNH PHÚC CỦA CHÚNG TÔI
          </Typography>
          ...
          <Typography
            ...
            color={theme.palette.primary.main}
          >
            Chúng tôi rất mong muốn cùng Quý Đại lý hợp tác để trao nhau cơ hội
            kinh doanh, cùng nhau phát triển vững mạnh.
          </Typography>
        </Grid>
        ...
        >
          <Grid item md={5} xs={12}>
            <Typography
              ...
              sx={{ paddingBottom: 4 }}
            >
              Khám phá các giải pháp sáng tạo và chất lượng của chúng tôi
            </Typography>
            <Typography
              variant="h6"
              textAlign={"center"}

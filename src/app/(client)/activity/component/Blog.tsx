  ...
  return (
    <ThemeProvider theme={blogTheme}>
      <Paper elevation={24} sx={{ mt: 4, mb: 4 }}>
        <Card>
          <Grid xs={12} container justifyContent={"space-evenly"} sx={{ p: 2 }}>
            <Grid
              xs={4}
              item
              sx={{
            ...
            >
              <Image src={activityImg} alt="Image" layout="responsive" />
            </Grid>
            <Grid xs={6} item sx={{ order: directionImg === "right" ? 0 : 1 }}>
              <Typography
                variant="h5"

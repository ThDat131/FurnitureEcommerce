...
export default function ProductComponent() {
  ...
  const showProductsCarousel = () => {
    ...
    for (let i = 0; i < items.length; i += sliderItems) {
      if (i % sliderItems === 0) {
        renderItems.push(
          <Grid container xs={12} p={5} spacing={2} key={`carousel-item-${i}`}>
        ...
        <Container sx={{ backgroundColor: "#fff", width: 1 }}>
          <Grid container xs={12}>
            ...
            >
              ...
              {/* <Typography sx={styleTitle}>NHÓM SẢN PHẨM</Typography> */}
              <Typography sx={styleTitle}>SẢN PHẨM</Typography>
            </Grid>
            ...
            >
              ...
              <Box>
                ...
                >
                  ...
                  hạn bảo qua số 0979 227 227). Sản phẩm đã bị thay đổi, sửa
                  chữa không thuộc các Trung Tâm Bảo Hành Ủy Quyền của Hãng. Sản
                  phẩm lắp đặt, bảo trì, sử dụng không đúng theo hướng dẫn của
                  Nhà sản xuất gây ra hư hỏng. Sản phẩm trong tình trạng bị khóa
                  tài khoản cá nhân như: Tài khoản khóa máy/màn hình, khóa tài
                  khoản trực tuyến Gmail, iCloud… Khách hàng sử dụng phần mềm,
                  ứng dụng không chính Hãng, không bản quyền. Màn hình có từ bốn
                  (04) điểm chết trở lên
                </Typography>
              </Box>
            </Grid>
          </Grid>
